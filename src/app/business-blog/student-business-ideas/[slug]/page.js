import { StudentBusinessIdeasBlogsList } from '../../../../../Data/StudentBusinessIdeasBlogsList';
import styles from './page.module.css';

export async function generateMetadata({ params }) {
   const resolvedParams = await params;
   const slug = resolvedParams.slug;
   const blog = StudentBusinessIdeasBlogsList.find(item => item.slug === slug);
   ...
   const fullUrl = `${siteUrl}/business-blog/student-business-ideas/${slug}`;
