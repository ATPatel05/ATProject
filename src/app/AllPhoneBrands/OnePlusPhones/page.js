...
export function generateMetadata() {
  ...
  const title = "All OnePlus Phones with full Specifications | Buy Online at Best price in India, USA & Canada - SkillUpLines"
  const description = "All OnePlus Phones with full Specifications Online at Best Prices. Buy Best Headphones, bluetooth Speakers, wirless headphones & Accessories of OnePlus Brand in India, USA, Canada, Germany & UK.";
  const keywords = [
    "OnePlus",
    "OnePlus Phones",
