...
export function generateMetadata() {
  ...
  const keywords = [
    "XiaoMI",
    "XiaoMI Phones",
    "Latest XiaoMI Phones 2025",
    "All XiaoMI Models",
    "XiaoMI Devices",
    "XiaoMI Mobile Specifications",
    "Latest XiaoMI Gadgets"
  ];
  ...
  return {
    ...
    category: "XiaoMI Phones, Gadgets & Accessories with specifications",
    robots: {
      index: true,
      follow: true,
      googleBot: {
  ...
  return (
    <main className={styles.container}>
      ...
      <div className={styles.mobile_blog}>
        <SectionHeader>XiaoMI</SectionHeader>
