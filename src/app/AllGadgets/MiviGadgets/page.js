...
export function generateMetadata() {
  ...
  const title = "Mivi Accessories & gadgets with Specification. Buy in india, USA, Canada | SkillUpLines"
  const description = "Mivi Accessories with Full Specifications Online at Best Prices on Amazon. Shop Top Headphones, bluetooth Speakers, wirless headphones & Accessories of Mivi Brand in India, USA, Canada, Germany & UK.";
  const keywords = [
    "Mivi accessories",
    "Mivi gadgets",
    "Mivi devices",
