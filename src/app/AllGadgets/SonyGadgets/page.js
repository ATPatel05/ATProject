...
export function generateMetadata() {
  ...
  const title = "Sony Accessories & gadgets with Specification. Buy in india, USA, Canada | SkillUpLines"
  const description = "Sony Accessories with Full Specifications Online at Best Prices on Amazon. Shop Top Headphones, bluetooth Speakers, wirless headphones & Accessories of Sony Brand in India, USA, Canada, Germany & UK.";
  const keywords = [
    "Sony accessories",
    "Sony gadgets",
    "Sony devices",
