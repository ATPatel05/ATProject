...
export function generateMetadata() {
  ...
  const title = "Realme Accessories & gadgets with Specification. Buy in india, USA, Canada | SkillUpLines"
  const description = "Realme Accessories with Full Specifications Online at Best Prices on Amazon. Shop Top Headphones, bluetooth Speakers, wirless headphones & Accessories of Realme Brand in India, USA, Canada, Germany & UK.";
  const keywords = [
    "Realme accessories",
    "Realme gadgets",
    "Realme devices",
