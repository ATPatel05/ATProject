...
export function generateMetadata() {
  ...
  const title = "Oppo Accessories & gadgets with Specification. Buy in india, USA, Canada | SkillUpLines"
  const description = "Oppo Accessories with Full Specifications Online at Best Prices on Amazon. Shop Top Headphones, bluetooth Speakers, wirless headphones & Accessories of Oppo Brand in India, USA, Canada, Germany & UK.";
  const keywords = [
    "Oppo accessories",
    "Oppo gadgets",
    "Oppo devices",
