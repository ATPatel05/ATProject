export const AllLuxuryNacklaceList = [
   
   {
      ...
      postName: 'Luxury Nacklace',
      ProductHeading: 'Samsang Galaxy S25 Ultra',
      Announced: 'Released 2025, September 04',
      folderPath: 'AllLuxuryProducts/LuxuryNacklace',
      Brand: 'LuxuryNacklace',
      ManufacturerLink: '/AllLuxuryProducts/LuxuryNacklaces',
